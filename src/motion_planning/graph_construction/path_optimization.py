...
class PathOptimizer:
    ...
    def sample_spiral(self, p):
        ...
        x_points = scipy.integrate.cumulative_trapezoid(np.cos(t_points), s_points, initial=0.0)
        y_points = scipy.integrate.cumulative_trapezoid(np.sin(t_points), s_points, initial=0.0)
